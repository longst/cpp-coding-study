# Data Structures Tracker

| Data structure / tool | Status | What to know | Practice problems |
|---|---|---|---|
| `std::vector` | Studied | Indexing, size, pass by reference, in-place write index, outer allocation versus inner contents | Remove duplicates, Remove element, Plus one, Zigzag conversion |
